...
# code doesn't work with test, and I'm not able to figure out why.    
...
#      end
  ...
  describe 'POST #create' do
    it 'increased the number of Advertisement by 1' do
      expect {
        post :create,
        advertisement: { title: RandomData.random_sentence, copy: RandomData.random_paragraph, price: 99}#RandomData.random_integer }
