...
RSpec.describe TopicsController, type: :controller do
    ...
    context "guest" do
        ...
        describe "PUT update" do
            it "returns http redirect" do
                ...
                put :update, id: my_topic, topic: {new: new_name, description: new_description }
                expect(response).to redirect_to(new_session_path)
            end
        end
    ...
    context "admin user" do
        before do
            user = User.create!(name: "Bloccit User", email: "user@blocit.com", password: "helloworld", role: :admin)
            create_session(user)
        end
        ...
        describe "POST create" do
            it "inscreases the number of topics by 1" do
    ...
    before do
        user = User.create!(name: "Bloccit User", email: "user@blocit.com", password: "helloworld", role: :moderator)
        create_session(user)
    end
